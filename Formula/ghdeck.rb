class Ghdeck < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/jitendravjh/ghdeck/releases/download/v0.1.2/ghdeck-aarch64-apple-darwin.tar.gz"
      sha256 "2625fe114a48274d4617940515915ba02305b0e4b31bd7d8f4c2e7ba9a589f20"
    end
    on_intel do
      url "https://github.com/jitendravjh/ghdeck/releases/download/v0.1.2/ghdeck-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/jitendravjh/ghdeck/releases/download/v0.1.2/ghdeck-aarch64-unknown-linux-musl.tar.gz"
      sha256 "59c56156ac54aa73cab4976c5288ccb00ba19f3d6397fb17a1decc31448a2c43"
    end
    on_intel do
      url "https://github.com/jitendravjh/ghdeck/releases/download/v0.1.2/ghdeck-x86_64-unknown-linux-musl.tar.gz"
